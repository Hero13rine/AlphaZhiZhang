...
class Board(object):
    ...
    def init_train_board(self, start_player=0):
        ...
        self.states = {}
        self.last_move = -1
        random_num = np.random.randint(1, 6)  # 返回1个[1,5)时间的随机整数
        random_pos = [80,  81,  82,  83,  84,
                      95,  96,  97,  98,  99,
                      110, 111, 112, 113, 114,
                      125, 126, 127, 128, 129,
                      140, 141, 142, 143, 144]

        move_list = np.random.choice(random_pos, random_num, p=[0.032875, 0.032875, 0.032875, 0.032875, 0.032875,
                                                                0.032875, 0.04908, 0.04908, 0.04908, 0.032875,
                                                                0.032875, 0.04908, 0.08136, 0.04908, 0.032875,
                                                                0.032875, 0.04908, 0.04908, 0.04908, 0.032875,
                                                                0.032875, 0.032875, 0.032875, 0.032875, 0.032875],
                                     replace=False)
