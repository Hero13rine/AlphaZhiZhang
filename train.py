...
class TrainPipeline():
    ...
    def collect_selfplay_data(self, n_games=1):
        ...
        for i in range(n_games):
            winner, play_data = self.game.start_self_play(self.mcts_player, is_shown=1,
                                                          temp=self.temp)
...
if __name__ == '__main__':
    training_pipeline = TrainPipeline('current_policy17000.model')
